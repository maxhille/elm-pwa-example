...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"message":"Main.Msg","aliases":{"Main.Post":{"type":"{ text : String }","args":[]}},"unions":{"Main.Msg":{"tags":{"TextChanged":["String"],"SendAndClear":[],"PostsChanged":["List Main.Post"]},"args":[]}}},"versions":{"elm":"0.18.0"}});
}
